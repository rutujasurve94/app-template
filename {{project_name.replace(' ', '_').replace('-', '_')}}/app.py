...
def config():
    parallel = {{parallel}} if sys.argv[1] == 'index' else 1
    shards = {{shards}}
    ...
    os.environ['JINA_PORT'] = os.environ.get('JINA_PORT', str({{public_port}}))
